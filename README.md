...
- [Ready-to-Use Code Templates](#-ready-to-use-code-templates)
- [Model Comparison Table](#-model-comparison-table)
- [Which Model Should I Use?](#-which-model-should-i-use)
- [AI Engineering Roadmaps](#-ai-engineering-roadmaps)
- [Prompt Engineering Guide](#-prompt-engineering-guide)
- [Security & Key Management](#-security--key-management)
- [Rate Limits & Cost Estimation](#-rate-limits--cost-estimation)
- [Awesome AI APIs](#-awesome-ai-apis)
...
|----------|--------------|-----------|--------------|-------------|---------------|
| **OpenAI** | [Get Key](https://platform.openai.com/api-keys) | ✅ $5 credit | [Pricing](https://openai.com/api/pricing) | LLM, Embeddings, Vision, Audio, TTS | [Docs](https://platform.openai.com/docs) |
| **Google AI Studio** | [Get Key](https://aistudio.google.com/apikey) | ✅ 60 req/min | [Pricing](https://ai.google.dev/pricing) | LLM, Embeddings, Vision, Audio | [Docs](https://ai.google.dev/docs) |
| **Anthropic** | [Get Key](https://console.anthropic.com/settings/keys) | ❌ | [Pricing](https://www.anthropic.com/pricing) | LLM, Vision | [Docs](https://docs.anthropic.com) |
| **Cohere** | [Get Key](https://dashboard.cohere.com/api-keys) | ✅ Limited | [Pricing](https://cohere.com/pricing) | LLM, Embeddings, Rerank | [Docs](https://docs.cohere.com) |
| **Mistral AI** | [Get Key](https://console.mistral.ai/api-keys) | ✅ Trial credits | [Pricing](https://mistral.ai/pricing) | LLM, Embeddings, Vision | [Docs](https://docs.mistral.ai) |
| **Groq** | [Get Key](https://console.groq.com/keys) | ✅ Limited | [Pricing](https://groq.com/pricing/) | LLM, Vision, Audio | [Docs](https://console.groq.com/docs) |
| **DeepSeek** | [Get Key](https://platform.deepseek.com/api_keys) | ✅ Credits | [Pricing](https://platform.deepseek.com/pricing) | LLM | [Docs](https://platform.deepseek.com/api-docs) |
| **Perplexity** | [Get Key](https://www.perplexity.ai/settings/api) | ❌ | [Pricing](https://www.perplexity.ai/pricing) | LLM, Search | [Docs](https://docs.perplexity.ai) |
| **Together AI** | [Get Key](https://api.together.xyz/settings/api-keys) | ✅ $25 credit | [Pricing](https://www.together.ai/pricing) | LLM, Embeddings, Image | [Docs](https://docs.together.ai) |
| **Fireworks AI** | [Get Key](https://fireworks.ai/api-keys) | ✅ Limited | [Pricing](https://fireworks.ai/pricing) | LLM, Image, Audio | [Docs](https://docs.fireworks.ai) |
| **Replicate** | [Get Key](https://replicate.com/account/api-tokens) | ❌ | [Pricing](https://replicate.com/pricing) | LLM, Image, Audio, Video | [Docs](https://replicate.com/docs) |
| **Hugging Face** | [Get Key](https://huggingface.co/settings/tokens) | ✅ Limited | [Pricing](https://huggingface.co/pricing) | LLM, Embeddings, All | [Docs](https://huggingface.co/docs) |
| **Voyage AI** | [Get Key](https://dash.voyageai.com/api-keys) | ✅ Limited | [Pricing](https://www.voyageai.com/pricing) | Embeddings, Rerank | [Docs](https://docs.voyageai.com) |
| **ElevenLabs** | [Get Key](https://elevenlabs.io/app/speech-synthesis) | ✅ 10k chars | [Pricing](https://elevenlabs.io/pricing) | TTS, Voice | [Docs](https://elevenlabs.io/docs) |
| **AssemblyAI** | [Get Key](https://www.assemblyai.com/dashboard/signup) | ✅ Limited | [Pricing](https://www.assemblyai.com/pricing) | STT, TTS, Understanding | [Docs](https://www.assemblyai.com/docs) |
| **xAI (Grok)** | [Get Key](https://console.x.ai/) | ❌ | [Pricing](https://x.ai/api) | LLM, Vision | [Docs](https://docs.x.ai) |
| **OpenRouter** | [Get Key](https://openrouter.ai/keys) | ✅ Limited | [Pricing](https://openrouter.ai/models) | LLM (100+ models) | [Docs](https://openrouter.ai/docs) |
| **Cerebras** | [Get Key](https://cloud.cerebras.ai/) | ✅ Limited | [Pricing](https://cerebras.ai/pricing) | LLM (ultra-fast inference) | [Docs](https://inference-docs.cerebras.ai) |
...
- [LlamaIndex RAG](https://docs.llamaindex.ai/en/stable/use_cases/q_and_a/)
...
- [Google Prompting Essentials](https://ai.google.dev/gemini-api/docs/prompting-intro)
...
**Example:** 500 tokens/request × 1,000 requests/day × 30 days = 15M tokens/month
At GPT-4o-mini input pricing ($0.15/1M): **$2.25/month input cost**
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for detailed guidelines and [CHANGELOG.md](CHANGELOG.md) for version history.
...
- **Issues**: [GitHub Issues](https://github.com/MusaIslamFahad/ai-integration-hub/issues)
- **Discussions**: [GitHub Discussions](https://github.com/MusaIslamFahad/ai-integration-hub/discussions)
...
[⬆ Back to Top](#-ai-integration-hub)
